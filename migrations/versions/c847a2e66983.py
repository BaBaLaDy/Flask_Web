...
Revision ID: c847a2e66983
Revises: dd65695bb70b
Create Date: 2022-10-03 16:33:22.050737
...
revision = 'c847a2e66983'
down_revision = 'dd65695bb70b'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['course_id'], ['course.id'], name='attendence_ibfk_1'),
    sa.ForeignKeyConstraint(['student_id'], ['student.id'], name='attendence_ibfk_2'),
    sa.PrimaryKeyConstraint('id'),
